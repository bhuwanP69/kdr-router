    ...
    return (
            ...
            />
                    ...
                    <button onClick={handleButtonClick}>
                        <h5 className="text-semibold text-3xl font-semibold hover:drop-shadow-xl hover:scale-105 duration-1000">Hirendra K.Singh</h5>
                    </button>
                    <p className="text-md">Account Officer</p>
                    {/* <p>BBS(T.U)</p> */}

                    {/* Use the ref to access the more-info container */}
                    <div ref={moreInfoRef} className={`more-info z-30 absolute h-60 w-96 bg-gray-200 top-0 -left-24 sm:left-0 ${showMoreInfo ? '' : 'hidden'}`}>
